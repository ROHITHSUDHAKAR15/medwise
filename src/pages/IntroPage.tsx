...
export default function IntroPage({ onLogin, onSignup }: IntroPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#scanner" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                AI Scanner
              </a>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Discover how MedWise transforms healthcare management with cutting-edge AI technology and intuitive design.
            </p>
          </div>
      ...
      <section id="scanner" className="py-20 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {interactiveElements.map((element, index) => (
              <div key={index} className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-300">
              Powered by cutting-edge technology for the best healthcare experience
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {advancedFeatures.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <section id="testimonials" className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              See what doctors and patients are saying about their MedWise experience.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative h-64 overflow-hidden">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-gradient-to-r from-blue-50 to-slate-50 dark:from-blue-900/20 dark:to-slate-900/20 rounded-2xl p-8 h-full flex items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <div>
                          ...
                          <div className="text-slate-500 dark:text-slate-400 text-sm">
                            {testimonial.role} • {testimonial.hospital || testimonial.condition || testimonial.family}
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-slate-600 to-blue-600 relative overflow-hidden">
