    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {['weight', 'heart_rate', 'blood_pressure', 'sleep'].map((type) => {
          ...
          return (
            <div key={type} className="card-enhanced p-6 hover-lift">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {metricTypes.map((metricType) => {
          ...
          return (
            <div key={metricType.type} className="card-enhanced p-6 hover-lift">
              <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex justify-end">
            <button
              onClick={() => {
                ...
                info('Goals Feature', 'Goal management features coming soon!');
              }}
              className="btn-primary"
            >
              Manage Goals
