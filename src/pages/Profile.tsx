...
import { User, Shield, Mail, Phone, Heart, Calendar, Edit, Settings, Camera, X, Save, Lock, FileText } from 'lucide-react';
        ...
        <div className="relative px-8 pb-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-end space-y-4 sm:space-y-0 sm:space-x-6 -mt-16">
            <div className="relative">
              <div className="w-32 h-32 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center border-4 border-white dark:border-gray-800 shadow-lg">
                <span className="text-white text-4xl font-bold">{user.name[0]}</span>
              </div>
              <button 
                onClick={() => info('Feature Coming Soon', 'Profile photo upload will be available soon!')}
